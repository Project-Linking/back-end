package tukorea.projectlink.global.login.filter;
...
public class CustomJsonUsernamePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private static final String USERNAME_KEY = "loginId"; // 회원 로그인 시 이메일 요청 JSON Key : "email"
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        ...
        Map<String,String> loginRequestJson = objectMapper.readValue(messageBody, Map.class);
        String loginId = loginRequestJson.get(USERNAME_KEY);
        String password = loginRequestJson.get(PASSWORD_KEY);
